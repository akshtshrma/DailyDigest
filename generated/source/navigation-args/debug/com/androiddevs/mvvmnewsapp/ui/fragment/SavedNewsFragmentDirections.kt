...
public class SavedNewsFragmentDirections private constructor() {
  private data class ActionSavedNewsFragmentToArticlePreviewFragment(
    public val article: Article,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_savedNewsFragment_to_articlePreviewFragment
  ...
  public companion object {
    public fun actionSavedNewsFragmentToArticlePreviewFragment(article: Article): NavDirections =
        ActionSavedNewsFragmentToArticlePreviewFragment(article)
  }
}

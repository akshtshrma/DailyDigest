...
public class BreakingNewsFragmentDirections private constructor() {
  private data class ActionBreakingNewsFragmentToArticlePreviewFragment(
    public val article: Article,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_breakingNewsFragment_to_articlePreviewFragment
  ...
  public companion object {
    public fun actionBreakingNewsFragmentToArticlePreviewFragment(article: Article): NavDirections =
        ActionBreakingNewsFragmentToArticlePreviewFragment(article)
  }
}
